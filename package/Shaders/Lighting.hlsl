...
#	endif
	...
	float dirLightAngle = dot(worldNormal.xyz, SharedData::DirLightDirection.xyz);
...
#	endif
	...
	float3 directionalAmbientColor = max(0, mul(SharedData::DirectionalAmbient, float4(worldNormal, 1.0)));
